...
package
{
	import com.distriqt.test.dynamicicon.Main;
	...
	/**	
	 * Sample application for using the DynamicIcon Native Extension
	 */
	public class TestDynamicIcon extends Sprite
	{
		////////////////////////////////////////////////////////
		//	CONSTANTS
		//
		 ...
		 *  Constructor
		 */
		public function TestDynamicIcon()
		{
			super();
			if(this.stage)
			{
