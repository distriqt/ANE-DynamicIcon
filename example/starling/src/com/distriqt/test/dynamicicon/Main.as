...
package com.distriqt.test.dynamicicon
{
	...
	public class Main extends Sprite implements ILogger
	{
		...
		private var _tests		: DynamicIconTests;
		...
		private function createUI():void
		{
			...
			_tests = new DynamicIconTests( this );

			
			addAction( "Alternate Icon", _tests.setAlternateIcon );
			addAction( "Primary Icon", _tests.setPrimaryIcon );
